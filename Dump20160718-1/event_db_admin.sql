...
INSERT INTO `admin` VALUES ('student1',1),('u2',1),('user2',1);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER update_user_type_a BEFORE INSERT ON `admin` 
FOR EACH ROW
BEGIN
	update users
    set user_type = 'a'
...
-- Dump completed on 2016-07-18 18:08:03
