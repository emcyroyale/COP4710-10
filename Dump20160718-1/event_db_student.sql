...
INSERT INTO `student` VALUES ('student1',1),('student2',1),('student3',1),('student4',1),('student5',1),('user2',1);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER update_user_type_S BEFORE INSERT ON `student` 
FOR EACH ROW
BEGIN
	update users
    set user_type = 's'
