...
INSERT INTO `super_admin` VALUES ('user1'),('username16');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER update_user_type_sa BEFORE INSERT ON `super_admin` 
FOR EACH ROW
BEGIN
	update users
    set user_type = 'sa'
