		...
		<div class="flex-container">
			...
			<nav class="nav">
				<ul>
					<?php
						if($_SESSION['user_type']== 's'){
							echo " 	<li><b> <a href=\"viewEvent.html\" target=\"_self\"> View Events</a></b></li> 
									<li><b> <a href=\"joinRSO.html\" target=\"_self\"> Join RSO</a></b></li> 
									<li><b> <a href=\"createRSO.html\" target=\"_self\"> Create RSO</a><br /></b></li>";
						}
						elseif($_SESSION['user_type']== 'a'){
							echo " 	<li><b> <a href=\"viewEvent.html\" target=\"_self\"> View Events</a></b></li> 
									<li><b> <a href=\"createEvent.html\" target=\"_self\"> Create Event</a><br /></b></li>
									<li><b> <a href=\"joinRSO.html\" target=\"_self\"> Join RSO</a></b></li>
									<li><b> <a href=\"createRSO.html\" target=\"_self\"> Create RSO</a><br /></b></li>";
						}
						if($_SESSION['user_type']== 'sa'){
							echo " 	<li><b> <a href=\"createUni.html\" target=\"_self\"> Create University</a></b></li>";
						}
					?>
				</ul>
			</nav>
